    ...
    <nav className="mx-4 md:mx-28 mt-6 rounded-xl bg-gradient-to-r from-[#0B3B8A] to-[#0B6FFF] px-6 py-3">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link to="/personalinformation" className="flex items-center space-x-2 bg-white rounded-full px-3 py-2 text-black font-semibold text-sm">
            <span>Iwan Manjul</span>
            <img
              alt="User avatar"
