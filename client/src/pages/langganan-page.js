    ...
    return(
        ...
        <>  {/* header */}
            ...
            <div className='w-full h-[150%] px-6 pt-10 flex flex-row gap-8 justify-center items-end bg-[#F6FAFE]'>
                ...
                <div className='flex flex-col h-[80%] w-1/5 overflow-hidden relative rounded-t-[40px] bg-gradient-to-r from-blue-900 via-[#0C68FF] to-[#60A5FA]'>
                    ...
                    <div className='flex flex-col h-[40%] rounded-tl-[40px] rounded-tr-[40px] gap-6 z-10 justify-center items-center'>
                        ...
                        <button className='px-5 py-1 font-bold bg-yellow-300 rounded-lg hover:bg-white hover:text-black'>Subscribe</button>
                    </div>
                    <div className='h-[60%] relative z-10 flex flex-col justify-center items-center text-center '>
                        <div className='flex flex-col'>
                ...
                <div className='flex flex-col h-[90%] w-1/5 overflow-hidden relative rounded-t-[40px] bg-gradient-to-r from-blue-900 via-[#0C68FF] to-[#60A5FA]'>
                ...
                <div className='flex flex-col h-[100%] w-1/5 overflow-hidden relative rounded-t-[40px] bg-gradient-to-r from-blue-900 via-[#0C68FF] to-[#60A5FA]'>
